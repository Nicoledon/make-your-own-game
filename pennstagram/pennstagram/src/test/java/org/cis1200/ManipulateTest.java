...
public class ManipulateTest {
    ...
    public static PixelPicture smallRect() {
        return new PixelPicture(
                new Pixel[][] {
                    { Pixel.BLACK },
                    { Pixel.RED }
    ...
    public static PixelPicture mediumRect() {
        return new PixelPicture(
                new Pixel[][] {
                    { Pixel.BLACK, Pixel.BLUE, Pixel.RED },
                    { Pixel.RED, Pixel.GREEN, Pixel.WHITE }
                }
        );
    }
    ...
    public static PixelPicture threeStripesRect(
            int r0, int g0, int b0,
            int r1, int g1, int b1,
            int r2, int g2, int b2
    ) {
        Pixel[][] bmp = new Pixel[128][256];
    ...
    public static PixelPicture doubleSmallRectBorder() {
        return new PixelPicture(
                new Pixel[][] {
                    { Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE },
                    { Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE },
                    { Pixel.WHITE, Pixel.WHITE, Pixel.BLACK, Pixel.WHITE, Pixel.WHITE },
                    { Pixel.WHITE, Pixel.WHITE, Pixel.RED, Pixel.WHITE, Pixel.WHITE },
                    { Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE },
                    { Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE, Pixel.WHITE }
                }
        );
    ...
    public void blurSmall() {
        assertTrue(
                12 >= // Off by one (for each component) is okay
                        PixelPicture.diff(
                                new PixelPicture(
                                        new Pixel[][] {
